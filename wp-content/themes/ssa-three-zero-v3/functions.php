...
function add_favicon() { ?>
    ...
    <link rel="icon" type="image/png" href="<?php echo bloginfo('url') ?>/favicon-96x96.png" sizes="96x96">
    ...
    <link rel="mask-icon" href="<?php echo bloginfo('url') ?>/safari-pinned-tab.svg" color="#ffbf3d">
...
if( !function_exists("wp_bootstrap_theme_styles") ) {
    function wp_bootstrap_theme_styles() {
        ...
        wp_register_style( 'app-1', get_stylesheet_directory_uri() . '/css/app.min.1.css', array(), '2.0.0.1', 'all' );
        wp_enqueue_style( 'app-1' );
        wp_register_style( 'app-2', get_stylesheet_directory_uri() . '/css/app.min.2.css', array(), '2.0.0.1', 'all' );
        wp_enqueue_style( 'app-2' );

        // For child themes
        wp_register_style( 'custom', get_stylesheet_directory_uri() . '/custom.css', array(), '2.0.0.1', 'all' );
        wp_enqueue_style( 'custom' );
        wp_register_style( 'custom1', get_stylesheet_directory_uri() . '/custom1.css', array(), '2.0.0.1', 'all' );
        wp_enqueue_style( 'custom1' );

        wp_register_style( 'style', get_stylesheet_directory_uri() . '/style.css', array(), '2.0.0.1', 'all' );
        wp_enqueue_style( 'style' );

        wp_register_style( 'backend', get_stylesheet_directory_uri() . '/backend.css', array(), '2.0.0.1', 'all' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'jquery-nicescroll',
      get_template_directory_uri() . '/vendor/jquery.nicescroll/jquery.nicescroll.min.js',
      array('jquery'),
      '1.2', true );
    ...
    wp_register_script( 'jquery-simplePagination',
      get_template_directory_uri() . '/js/jquery.simplePagination.js',
      array('jquery'),
      '1.2', true );
    ...
    wp_register_script( 'owl-carousel',
      ...
      array('jquery', 'jquery-version-2.1.1'),
      '1.2', true );

    wp_register_script( 'snap',
      get_template_directory_uri() . '/js/snap.svg-min.js',
      array('jquery'),
      '1.2', true );
...
function the_copyright($dateNow) { ?>
    <?php bloginfo( 'name' ); ?> &copy; <?php _e('Copyright', 'blanket'); ?> <?php echo $dateNow; ?> <?php if(date('Y') !== $dateNow){ echo "- " . date('Y');} ?>.<?php
}

function the_developer($name="SSAManila") {
    echo "Developed by " . $name;
}
