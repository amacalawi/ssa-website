...
<body <?php body_class(); ?>>
	<section id="banner" class="banner <?php echo ($post->post_type=='page'?$post->post_name:$post->post_type) ?>_banner bg section" data-bg="<?php echo get_the_post_thumbnail_url_raw() ?>">
